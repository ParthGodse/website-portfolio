            ...
            <div className="flex gap-3">
              ...
              {project.liveUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 px-4 py-2 bg-white border border-blue-300 text-blue-600 rounded-lg hover:border-blue-700 transition-all duration-300 text-sm font-medium transform hover:scale-105"
                >
